...
COPY --from=build_base /temp-build/gcp-serviceAccount.json ./gcp-serviceAccount.json
COPY --from=build_base /temp-build/serviceAccountKey.json ./serviceAccountKey.json
